  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100">
      ...
      <header className="px-6 sm:px-10 py-6  pb-10 grid-cols-3 items-center gap-4 w-full max-w-7xl mx-auto text-center">
        ...
        <nav className="hidden md:flex items-center justify-center gap-20 text-sm font-medium">
          ...
          <h1 className="text-xl sm:text-2xl font-extrabold tracking-tight">
            Hero <span style = {{color: "#E6492D"}}> <br />Webs</span>
          </h1>
      ...
      <main className="flex-grow flex flex-col items-center text-center gap-12 px-8 pb-20">
        <section className="flex flex-col md:flex-row items-center gap-8 max-w-6xl w-full bg-red">
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight">
              La web <span className=" text-nowrap " style = {{color: "#E6492D"}}>con más ROI</span> <br /> del mercado
            </h2>
        ...
        {/* SOBRE MÍ */}
        <section className="flex flex-col md:flex-row items-center gap-8 max-w-6xl w-full">
          ...
          <div className="text-left md:text-left flex flex-col gap-4">
            ...
            <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-300 max-w-xl">
              Mi nombre es Pablo, estudiante de doble grado y apasionado por automatizar procesos en compañías tradicionales para impulsar sus ventas y aumentar su conversión.
            </p>
            <Link
              href="#contacto"
        ...
        <section id = "resumen" className = ""> 
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold text-center tracking-tight leading-snug p-4">
            No es solo una web.
            <br />
            <span className="text-orange-500">Es la evolución de tu negocio.</span>
          </h3>

          
          <ul className="list-none space-y-3 text-justify text-lg md:text-xl font-medium text-neutral-800 dark:text-neutral-100">
            <li>✅ Transforma tu web en una herramienta real de ventas, no un simple escaparate.</li>
            <li>✅ Di adiós a las llamadas perdidas: cada contacto es una oportunidad que ya no se escapa.</li>
            <li>✅ Aprovecha tus reseñas para destacar frente a tu competencia — incluso las negativas juegan a tu favor.</li>
            <li>✅ Mantente al tanto de lo que hace tu competencia sin mover un dedo.</li>
            <li>✅ Deja que la tecnología trabaje por ti, mientras tú te centras en lo que importa: hacer crecer tu negocio.</li>
          </ul>
        ...
        <section id="Reservar" className="pt-12">
          <div className="max-w-6xl mx-auto px-4 flex columns-2 items-center text-center">
            
            <div className = "p-3">
              <h2 className="text-4xl font-bold mb-8 p-6 w-full">¿Hablamos?</h2>
              <p> En 15 minutos diseñamos un plan digital para que dejes de perder oportunidades </p>
            </div>

            <div className="w-full max-w-3xl h-full">
              <iframe
                src="https://calendly.com/pablo-lpz/30min"
                className="w-full h-[500px] border-none rounded-xl shadow-lg"
                title="Calendly"
                allow="fullscreen"
              ></iframe>
            </div>
...
function ServiceCard({ icon, alt, title, description, buttonLink, buttonText }: {
  icon: string;
  alt: string;
  title: string;
  description: string;
  ...
  return (
    <div  className="flex flex-col items-center text-center p-6 rounded-4xl shadow-lg transition-shadow hover:shadow-xl bg-gradient-to-br from-neutral-200 via-neutral-500 to-neutral-900">
      ...
      <p className="mt-2 pb-4 text-sm text-neutral-300">
        {description}
      </p>
